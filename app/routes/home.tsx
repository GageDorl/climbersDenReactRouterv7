...
export default function Home() {
  return (
    <div className="min-h-screen" style={{background: 'linear-gradient(to bottom, var(--surface), var(--background))'}}>
      {/* Hero Section */}
      <div className="container mx-auto px-4 py-16">
        <div className="text-center max-w-4xl mx-auto">
          <h1 className="text-5xl md:text-7xl font-bold text-primary mb-6">
            Welcome to <span style={{color: 'var(--primary-color)'}}>climbersDen</span>
          </h1>
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto mt-20">
          <Card>
            <CardHeader>
              <div className="w-12 h-12 rounded-lg flex items-center justify-center mb-4" style={{backgroundColor: 'var(--primary-color)', opacity: 0.2}}>
          ...
          <Card>
            <CardHeader>
              <div className="w-12 h-12 rounded-lg flex items-center justify-center mb-4" style={{backgroundColor: 'var(--success-color)', opacity: 0.2}}>
          ...
          <Card>
            <CardHeader>
              <div className="w-12 h-12 rounded-lg flex items-center justify-center mb-4" style={{backgroundColor: 'var(--accent-color)', opacity: 0.2}}>
        ...
        <div className="text-center mt-20">
          <Card className="max-w-2xl mx-auto border-0" style={{background: 'linear-gradient(to right, var(--primary-color), var(--primary-hover))', color: 'white'}}>
            <CardHeader>
            ...
            <CardContent>
              <Button asChild size="lg" variant="outline" className="bg-white hover:bg-white/90" style={{color: 'var(--primary-color)'}}>
